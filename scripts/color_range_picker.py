...
def main():
    ...
    im = cv2.imread('/home/anatole/Work/iris/assets/images/screenshot_gymnasium.png')
    cb = cv2.imread('/home/anatole/Work/iris/assets/images/screenshot_gymnasium.png')
